...
export function History() {
    ...
    return (
        <section className="max-w-100 md:max-w-4xl mx-auto h-[calc(100vh-120px)] overflow-hidden space-y-6 px-6 py-6">
            ...
            <div
                className="bg-primary flex flex-row justify-between p-4 md:p-6 rounded-lg md:justify-start md:space-x-12">
                <button
                    className={
            ...
            <div
                className="rounded-2xl bg-white/70 border border-gray-100 shadow-sm p-4 overflow-y-auto h-[calc(100vh-310px)] pb-20">
                {currentPage === "applications" && (
