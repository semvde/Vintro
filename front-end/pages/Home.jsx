            ...
            <section className="flex flex-col space-y-15">
                <div>
                    ...
                    <div className="mt-5 flex justify-between">
                        <Link className="bg-primary shadow-md pb-3 pt-3 pl-8 pr-8 rounded-3xl text-white" to="/register">Start nu! </Link>
                        <a className="bg-white pb-3 pt-3 pl-8 pr-8 shadow-md rounded-3xl text-black" href="#tutorial">Zo werkt het</a>
                    </div>
                </div>
